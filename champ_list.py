...
iterate_list = ["Aatrox", "Ahri", "Akshan", "Alistar", "Amumu", "Anivia", "Annie", "Aphelios",
    ...
    "Kha'Zix", "Kindred", "Kled", "Kog'Maw", "K'Sante", "LeBlanc", "Lee Sin", "Leona", "Lillia",
...
champions = [
    "Akshan","Ambessa",
    "Aurelion Sol", "Aurora", "Bel'Veth", "Blitzcrank", "Brand",
    "Braum", "Briar", "Caitlyn", "Camille", "Cassiopeia", "Cho'Gath", "Corki", "Darius",
    "Diana", "Dr. Mundo", "Draven", "Ekko", "Elise", "Evelynn", "Ezreal", "Fiddlesticks",
    "Fiora", "Fizz", "Galio", "Gangplank", "Garen", "Gnar", "Gragas", "Graves", "Gwen",
    "Hecarim", "Heimerdinger", "Hwei", "Illaoi", "Irelia", "Ivern", "Janna", "Jarvan IV",
...
for champ in champ_list:
    if champ not in iterate_list:
        print(champ)

print(len(champions)+11)